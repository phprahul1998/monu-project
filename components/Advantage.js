        ...
        <div className="row">
          <div className="col-md-12 col-sm-12 col-xs-12">
            <h2
              ...
              dangerouslySetInnerHTML={{ __html: t("advantages.heading") }}
            />
          </div>
              ...
              <div className="row">
                <div className="col-md-6 col-sm-6 col-xs-12">
                  <div className="about-image">
                    <img
                      src={`${t(advantage.image)}`}
                      alt=""
                      className="ab-first-img"
                    />
                    <img
                      src={`${t(advantage.thumbnail)}`}
                      alt=""
                      className="ab-second-img"
                    />
                    <a
                      target="_blank"
                      href={`${t(advantage.videlink)}`}
          ...
          <div className="col-md-12 col-sm-12 col-xs-12">
            <h2
              className="pt-3"
              dangerouslySetInnerHTML={{ __html: t("advantages.ourtip") }}
            />
