          ...
          <div className="col-md-12 col-sm-12 col-xs-12">
            <h2
              ...
              dangerouslySetInnerHTML={{
                __html: t("advantages_page.third_page_image.heading"),
              }}
            />
          </div>
          <div className="row">
            <div className="col-md-6 col-sm-6 col-xs-12">
              <div className="about-image">
                <img
                  src={`${t("advantages_page.third_page_image.image")}`}
                  alt=""
                  className="ab-first-img"
                />
                <img
                  src={`${t("advantages_page.third_page_image.thumbnail")}`}
                  alt=""
                  className="ab-second-img"
                />
                <a
                  target="_blank"
                  href={`${t("advantages_page.third_page_image.videlink")}`}
            ...
            <div className="col-md-6 col-sm-6 col-xs-12">
              <div className="about-content">
                <p
                  dangerouslySetInnerHTML={{
                    __html: t("advantages_page.third_page_image.para"),
                  }}
                />
              </div>
            </div>
